 ...
 * page console for "[Backlog Radar] Scanned N games" to confirm it
...
(function () {
  ...
  function save(games) {
    chrome.storage.local.set(
      ...
      () => {
        console.log(`[Backlog Radar] Scanned ${games.length} games from your Steam library.`);
      }
    );
  }
